...
При входе первого игрока в комнату со статусом `new`:
...
Это обеспечивает плавный переход между состояниями комнаты без необходимости внешнего триггера.
