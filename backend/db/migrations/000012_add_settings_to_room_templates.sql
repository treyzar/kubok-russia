...
ADD CONSTRAINT check_game_type CHECK (game_type IN ('train', 'fridge')),
ADD CONSTRAINT check_round_duration CHECK (round_duration_seconds BETWEEN 10 AND 3600),
ADD CONSTRAINT check_start_delay CHECK (start_delay_seconds BETWEEN 5 AND 600);
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
ALTER TABLE room_templates
DROP CONSTRAINT IF EXISTS check_start_delay,
DROP CONSTRAINT IF EXISTS check_round_duration,
